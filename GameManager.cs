...
public class GameManager : MonoBehaviour
{
    ...
    private List<(string, string, int)> gameQuestions = new List<(string, string, int)>();
    ...
    void StartTaskOnClick() {
        ...
        foreach (var x in packs) 
        {
            ...
            {
                gameQuestions.Add((y, packFormat, packDifficulty));
            }
        }
    ...
    void populateScrollView(string player) {
